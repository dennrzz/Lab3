...
City *ConnectedCity::getSource() const {
    return source;
}

void ConnectedCity::setSource(City *aSource) {
    ConnectedCity::source = aSource;
}

City *ConnectedCity::getTarget() const {
    return target;
}

void ConnectedCity::setTarget(City *aTarget) {
    ConnectedCity::target = aTarget;
}

int ConnectedCity::getMiles() const {
    return miles;
}

void ConnectedCity::setMiles(int inMiles) {
    ConnectedCity::miles = inMiles;
}
